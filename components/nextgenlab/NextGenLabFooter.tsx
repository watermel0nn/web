...
export default function NextGenLabFooter() {
  return (
    <footer className="bg-slate-900 text-slate-300 py-16 border-t border-slate-800 font-inter">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Cột 1: Brand & Social */}
          <div>
            <Link href="/nextgenlab" className="flex items-center gap-2 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/nextgenlab" className="hover:text-white hover:underline transition-all">Trang chủ</Link></li>
              <li><Link href="/nextgenlab/about" className="hover:text-white hover:underline transition-all">Về chúng tôi</Link></li>
              <li><Link href="/nextgenlab/products" className="hover:text-white hover:underline transition-all">Hệ sinh thái Giải pháp</Link></li>
              <li><Link href="/nextgenlab/news" className="hover:text-white hover:underline transition-all">Tin tức & Sự kiện</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/" className="hover:text-white hover:underline transition-all flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-blue-500"></span>KidzEconomy</Link></li>
