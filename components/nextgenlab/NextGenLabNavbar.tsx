...
const NAV_LINKS = [
  { label: 'Trang chủ', href: '/nextgenlab' },
  { label: 'Về chúng tôi', href: '/nextgenlab/about' },
  { label: 'Hệ sinh thái', href: '/nextgenlab/products' },
  { label: 'Tin tức', href: '/nextgenlab/news' },
];

export default function NextGenLabNavbar() {
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/nextgenlab" className="flex items-center gap-2 group">
